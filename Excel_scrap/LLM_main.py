...
from Excelscrap import Excelscrap
from langchain_google_genai import GoogleGenerativeAI
from langchain_core.prompts import ChatPromptTemplate
# 設置 Google API 密鑰
os.environ["GOOGLE_API_KEY"] = "AIzaSyByxnWsalrjFdslxrJ6GHsIby_Sl30IXS8"
...
async def main():
    ...
    documents = Excelscrap.Process_Excel(Excel_file)
    neo4j = Def_relationships("bolt://localhost:7687","neo4j","123456789","neo4j")
    entities = []
    relationships = []
